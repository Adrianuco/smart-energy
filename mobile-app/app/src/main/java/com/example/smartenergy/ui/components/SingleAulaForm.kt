...
fun SingleAulaForm(initialBuildingName: String?) {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        OutlinedTextField(value = aulaNombre, onValueChange = { aulaNombre = it }, label = { Text("Nombre del Aula (ej: B-101)") }, modifier = Modifier.fillMaxWidth())
        OutlinedTextField(value = floor, onValueChange = { floor = it }, label = { Text("Piso") }, modifier = Modifier.fillMaxWidth(), keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number))
        ...
        Button(
            ...
            Text("Registrar Aula Individual")
        }
    }
}